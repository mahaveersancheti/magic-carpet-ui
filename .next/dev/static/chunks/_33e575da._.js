...
function Sidebar() {
    ...
    if ($[0] !== "6b65db6f133d3e9a995e721da485fd950daceb858e73fd13699e37b74f8a91c9") {
        for(let $i = 0; $i < 20; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "6b65db6f133d3e9a995e721da485fd950daceb858e73fd13699e37b74f8a91c9";
    }
    ...
    if ($[1] !== router) {
        t0 = ({
            "Sidebar[handleNavigation]": (label)=>{
    ...
    if ($[5] !== handleNavigation) {
        t3 = ({
            "Sidebar[<a>.onClick]": ()=>handleNavigation("Dashboard")
        })["Sidebar[<a>.onClick]"];
        $[5] = handleNavigation;
        $[6] = t3;
    } else {
    ...
    const t4 = `flex items-center gap-3 px-5 py-3 rounded-xl cursor-pointer
    ...
    let t7;
    if ($[11] !== handleNavigation || $[12] !== selectedMenu) {
        t7 = menuItems.map({
            "Sidebar[menuItems.map()]": (t8)=>{
                const [icon, label_0] = t8;
                return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("a", {
                    onClick: {
                        "Sidebar[menuItems.map() > <a>.onClick]": ()=>handleNavigation(label_0)
                    }["Sidebar[menuItems.map() > <a>.onClick]"],
                    className: `flex items-center gap-3 px-5 py-3 rounded-xl cursor-pointer transition
                                ${selectedMenu === label_0 ? "bg-[#1B7FE6] text-white shadow-[0_4px_12px_rgba(27,127,230,0.35)]" : "text-gray-200 hover:shadow-neo-light-concave dark:hover:shadow-neo-dark-concave"}
                            `,
                    children: [
...
_s(Sidebar, "ghVBzsXiTtmUuWTgTVxfKy9LOPo=", false, function() {
    return [
...
function ProtectedLayout(t0) {
    ...
    if ($[0] !== "a433515b6ea41ee73287314f2ac564a3f88ce4a6906c9dea82263aeede0c865b") {
        for(let $i = 0; $i < 5; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "a433515b6ea41ee73287314f2ac564a3f88ce4a6906c9dea82263aeede0c865b";
    }
    const { children } = t0;
    let t1;
    let t2;
...
//# sourceMappingURL=_33e575da._.js.map