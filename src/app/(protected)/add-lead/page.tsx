...
export default function AddLeadPage() {
  ...
  const [errors, setErrors] = useState<
    Partial<Record<keyof CreateProfilePayload | "products", string>>
  >({});

  const [initialFormData, setInitialFormData] =
    useState<CreateProfilePayload | null>(null);
    ...
    if (id && profiles.length > 0 && !initialFormData) {
      ...
      if (profile) {
        setFormData({
          ...
          country:
            profile.country || profile.location?.split(",")[1]?.trim() || "",
          industryName:
            profile.industryType ||
            profile.industryOutlook?.[0]?.industry ||
            "",
        ...
        if (
          profile.productIds &&
          Array.isArray(profile.productIds) &&
          profile.productIds.length > 0
        ) {
          matchedProducts = products.filter((p) =>
            profile.productIds.includes(p.id),
          );
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.error(
        error.message || `Failed to ${id ? "update" : "create"} profile`,
      );
  ...
  return (
    <>
          ...
          <div>
            <h1 className="text-xl font-bold text-gray-900">
              <span className="text-[#111318]">
                {id ? "Edit Lead" : "New Lead Registration"}
              </span>
            </h1>
      ...
      <main className="max-w-[1280px] mx-auto px-6 py-8 bg-background-light min-h-screen">
        ...
        {/* <div className="sticky top-0 z-50 bg-background-light pt-8 -mt-8 pb-5 mb-5 border-b border-gray-100 shadow-sm">
              ...
              >
                ...
                <label className="flex flex-col gap-1.5">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      handleInputChange("industryName", e.target.value)
                    }
                    disabled={createLoading || updateLoading}
                ...
                <label className={`flex flex-col gap-1.5 ${currentType === "company" ? "md:col-span-1" : "md:col-span-2"}`}>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        handleInputChange("linkedinProfileLink", e.target.value)
                      }
                      disabled={createLoading || updateLoading}
                ...
                <label className="flex flex-col gap-1.5 md:col-span-1">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        handleInputChange("twitterProfileLink", e.target.value)
                      }
                      disabled={createLoading || updateLoading}
                ...
                <label className="flex flex-col gap-1.5 md:col-span-1">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        handleInputChange("facebookProfileLink", e.target.value)
                      }
                      disabled={createLoading || updateLoading}
                ...
                <label className="flex flex-col gap-1.5 md:col-span-1">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        handleInputChange("personalProfileLink", e.target.value)
                      }
                      disabled={createLoading || updateLoading}
                  ...
                  <div className="relative" ref={dropdownRef}>
                    ...
                    >
                      ...
                      {selectedProducts.map((product) => (
                        <span
                          key={product.id}
                          className="px-2 py-0.5 bg-primary/10 text-primary rounded-md text-[10px] lg:text-[11px] font-bold flex items-center gap-1 border border-primary/10 h-fit animate-in fade-in zoom-in duration-200"
                        >
                          {product.name}
                          <button
                            type="button"
            ...
            <div className="bg-white border border-gray-100 rounded-xl p-5 relative overflow-hidden shadow-sm">
              ...
              <div className="space-y-3">
                <div className="flex items-center justify-between py-1.5 border-b border-gray-50">
                  <span className="text-[10px] font-bold text-[#606e8a] uppercase tracking-wider">
                    Industry
                  </span>
              ...
              <ul className="space-y-3">
                <li className="flex gap-2.5">
                  ...
                  <p className="text-xs text-[#606e8a] leading-relaxed">
                    ...
                    helps in tailored marketing automation.
                  </p>
                </li>
                <li className="flex gap-2.5">
                  <span className="material-symbols-outlined text-primary text-sm mt-0.5">
                  ...
                  <p className="text-xs text-[#606e8a] leading-relaxed">
                    ...
                    allow for one-click profile viewing from the list view.
                  </p>
                </li>
                <li className="flex gap-2.5">
                  <span className="material-symbols-outlined text-primary text-sm mt-0.5">
